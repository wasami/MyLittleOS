...
printf "%s\n" "${toolchain}gcc ${cflags} ${scriptdir}/src/*.c ${scriptdir}/src/*.s -o ${kernel_elf}"
${toolchain}gcc ${cflags} ${lflags} ${scriptdir}/src/*.c ${scriptdir}/src/*.s -o ${kernel_elf}
...
# Move executable and image to build folder
mv kernel* build/